...
if (isset($_POST['simpan'])) {
    ...
    $check_code = mysqli_query($koneksi, "SELECT * FROM meja_221042 WHERE kode_meja_221042='$kode_meja'");
    if(mysqli_num_rows($check_code) > 0) {
        echo "<script>
                alert('Error: Kode meja sudah terdaftar!');
            </script>";
    } else {
        // Query to save data to database
        $simpan = mysqli_query($koneksi, "INSERT INTO meja_221042 
                                        (kode_meja_221042, nomor_meja_221042, kapasitas_221042, status_221042) 
                                        VALUES 
                                        ('$kode_meja', '$nomor_meja', '$kapasitas', '$status')");
        ...
        if ($simpan) {
            ...
            echo "<script>
                    alert('Gagal menambahkan meja! " . mysqli_error($koneksi) . "');
                </script>";
        }
    }
}
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="POST">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="kode_meja" name="kode_meja" placeholder="Kode Meja" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="nomor_meja">Nomor Meja</label>
                                        <input type="text" class="form-control" id="nomor_meja" name="nomor_meja" placeholder="Nomor Meja" required>
                                    </div>
                                    <div class="form-group">
